    ...
    <div className={style.backUsers}>
      ...
      <div className={style.control}>
        <input
          ...
          id="name"
          ref={nameInput}
          defaultValue={user.name} // Set defaultValue to display user name
        />
      </div>
      <div className={style.control}>
        <input
          ...
          id="username"
          ref={usernameInput}
          defaultValue={user.username} // Set defaultValue to display user username
        />
      </div>
      <div className={style.control}>
        <input
          ...
          id="name"
          ref={passwordInput}
          defaultValue={user.password} // Set defaultValue to display user password
        />
      </div>
      ...
      <div className={style.control}>
        <input
          ...
          id="email"
          ref={emailInput}
          defaultValue={user.email} // Set defaultValue to display user email
        />
      </div>
      ...
      <div className={style.control}>
        <input
          ...
          id="phone"
          ref={phoneInput}
          defaultValue={user.phone} // Set defaultValue to display user phone
        />
      </div>
      <div className={style.control}>
        <input
          ...
          id="birthday"
          ref={birthdayInput}
          defaultValue={user.birthday} // Set defaultValue to display user birthday
        />
      </div>
