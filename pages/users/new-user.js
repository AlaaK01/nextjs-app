...
const newUser = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const enteredRole = role === 'user' ? userInput.current.value : adminInput.current.value;
const enteredGender = gender === 'male' ? maleInput.current.value : femaleInput.current.value;
  ...
  return (
    <div className={style.backUsers}>
      ...
      <form className={style.form}>
        ...
        {/* <div className={style.control}>
          <input type="text" placeholder="Role..." id="role" ref={roleInput} />
        </div> */}
